...
public class Fri extends AppCompatActivity implements ValueEventListener{
    ImageView imageView;
    TextView textView;
    private FirebaseDatabase firebaseDatabase=FirebaseDatabase.getInstance();
    private DatabaseReference databaseReference=firebaseDatabase.getReference();
    private DatabaseReference first=databaseReference.child("fri").child("image");
    private DatabaseReference second=databaseReference.child("fri").child("text");
