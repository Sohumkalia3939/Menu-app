...
public class Saturday extends AppCompatActivity implements ValueEventListener{
    ImageView imageView;
    TextView textView;
    private FirebaseDatabase firebaseDatabase=FirebaseDatabase.getInstance();
    private DatabaseReference databaseReference=firebaseDatabase.getReference();
    private DatabaseReference first=databaseReference.child("sat").child("image");
    private DatabaseReference second=databaseReference.child("sat").child("text");
