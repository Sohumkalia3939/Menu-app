...
public class Wen extends AppCompatActivity implements ValueEventListener{
    ImageView imageView;
    TextView textView;
    private FirebaseDatabase firebaseDatabase=FirebaseDatabase.getInstance();
    private DatabaseReference databaseReference=firebaseDatabase.getReference();
    private DatabaseReference first=databaseReference.child("wen").child("image");
    private DatabaseReference second=databaseReference.child("wen").child("text");
